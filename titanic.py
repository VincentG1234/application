"""
Script d'analyse des données du Titanic.

Ce fichier contient des fonctions pour charger, nettoyer et analyser 
les données du jeu de données Titanic.
"""
...
# Parametrisation du script
parser = argparse.ArgumentParser(description="Combien d'arbres ?")
parser.add_argument(
    "--arbre", type=int, default=20, help="un entier naturel"
)
args = parser.parse_args()
print(args.arbre)

# Recupere les variables environnements
...
# On _split_ notre _dataset_ d'apprentisage pour faire de la validation croisée une
# partie pour apprendre une partie pour regarder le score.
